...
while True : 
    ...
    shotname ="screen.png"
    with open(shotname, 'wb') as f:
        f.write(image)

    image = Image.open(shotname)
    image = numpy.array(image, dtype=numpy.uint8)

    #Uncomment the following line to check the value is correct or not for your screen resolution
    # print(image[1600])

    pixels = [list(i[:3]) for i in image[1600]]
    ...
    print('Jumping a distance of '+str(int(distance))+ " pixels.")
